...
('admin', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'admin'), -- password: secret
('dr.silva', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'doctor'),
('dr.perera', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'doctor'),
('dr.fernando', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'doctor'),
('dr.jayawardene', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'doctor'),
('nurse.kumari', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'nurse'),
('nurse.siri', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'nurse'),
('recept.nimal', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'receptionist'),
('recept.sunil', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'receptionist'),
('manager.priya', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'manager');
...
(2, 'Ruwan', 'Silva', 1, 'SLMC001234', '+94771234567', 'r.silva@medsync.lk', 1, true),
(3, 'Kamala', 'Perera', 2, 'SLMC002345', '+94772345678', 'k.perera@medsync.lk', 1, true),
(4, 'Sunil', 'Fernando', 3, 'SLMC003456', '+94773456789', 's.fernando@medsync.lk', 2, true),
(5, 'Priyanka', 'Jayawardene', 4, 'SLMC004567', '+94774567890', 'p.jayawardene@medsync.lk', 3, true),
(6, 'Kumari', 'Wickramasinghe', NULL, 'SLN001234', '+94775678901', 'k.wickramasinghe@medsync.lk', 1, true),
(7, 'Siri', 'Bandara', NULL, 'SLN002345', '+94776789012', 's.bandara@medsync.lk', 2, true);
...
-- Consultations
('General Consultation', 'Standard consultation with general practitioner', 2500.00, 1, true),

-- Diagnostic Tests
('Blood Test - Full Blood Count', 'Complete blood count analysis', 1500.00, 2, true),

-- Minor Procedures
('Wound Dressing', 'Cleaning and dressing of wounds', 1500.00, 3, true),

-- Vaccinations
('COVID-19 Vaccination', 'COVID-19 vaccine administration', 2000.00, 4, true),

-- Emergency Care
('Emergency Consultation', 'Emergency medical consultation', 5000.00, 5, true);
...
('Amal', 'Perera', '1985-03-15', 'Male', 1, '+94711234567', 'amal.perera@gmail.com', 1, true),
('Nirmala', 'Silva', '1978-07-22', 'Female', 2, '+94722345678', 'nirmala.silva@yahoo.com', 1, true),
('Kasun', 'Fernando', '1990-11-08', 'Male', 3, '+94733456789', 'kasun.fernando@hotmail.com', 1, true),
('Sanduni', 'Wijesinghe', '1982-05-30', 'Female', 4, '+94744567890', 'sanduni.w@gmail.com', 2, true),
('Rohan', 'Jayawardene', '1975-12-12', 'Male', 5, '+94755678901', 'rohan.j@yahoo.com', 2, true),
('Chamika', 'Bandara', '1988-09-03', 'Male', 6, '+94766789012', 'chamika.b@gmail.com', 3, true),
('Dilani', 'Wickramasinghe', '1992-02-18', 'Female', 7, '+94777890123', 'dilani.w@hotmail.com', 3, true),
('Nuwan', 'Rathnayake', '1980-06-25', 'Male', 8, '+94788901234', 'nuwan.r@gmail.com', 2, true);

-- Insert patient emergency contacts
INSERT INTO patient_contacts (patient_id, name, phone, relation) VALUES
(17, 'Malini Perera', '+94711234568', 'Wife'),
(18, 'Sunil Perera', '+94711234569', 'Father'),
(19, 'Ravi Silva', '+94722345679', 'Husband'),
(20, 'Kumari Fernando', '+94733456780', 'Mother'),
(21, 'Ajith Wijesinghe', '+94744567891', 'Husband'),
(22, 'Kamani Jayawardene', '+94755678902', 'Wife'),
(23, 'Saman Bandara', '+94766789013', 'Brother'),
(24, 'Chandra Wickramasinghe', '+94777890124', 'Mother');
...
-- Past appointments
(17, 1, 1, '2025-09-10 09:00:00', 'Completed', 'Regular', 'Annual checkup'),

-- Future appointments
(20, 3, 2, '2025-09-18 10:00:00', 'Scheduled', 'Follow-up', 'Blood pressure monitoring'),

-- Emergency appointment
(24, 1, 1, '2025-09-14 18:30:00', 'Completed', 'Emergency', 'Sudden fever and headache');
